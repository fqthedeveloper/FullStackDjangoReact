...
function Contact() {
  ...
  return (
    ...
    <div className="container mt-4">
      <div className="row">
        <div className="col-7">
          {contactData.status === 'success' && <p className='text-success'>Thanks For Your Contact US</p>}
          {contactData.status === 'error' && <p className='text-danger'>Something Wrong Happend</p>}
          <div className="card">
